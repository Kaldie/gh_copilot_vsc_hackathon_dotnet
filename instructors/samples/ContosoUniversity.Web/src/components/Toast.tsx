...
function Toast({ notification, onClose }: { notification: NotificationDto; onClose: () => void }) {
  ...
  return (
    <div className="pointer-events-auto w-80 rounded-md border border-blue-300 bg-white p-4 shadow-lg dark:border-blue-700 dark:bg-gray-800">
      <div className="flex items-start justify-between">
        ...
        <button onClick={onClose} className="ml-3 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300" aria-label="Close">
          &times;
        </button>
      </div>
    </div>
