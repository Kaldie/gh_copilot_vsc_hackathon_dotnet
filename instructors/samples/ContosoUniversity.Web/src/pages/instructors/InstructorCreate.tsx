...
export default function InstructorCreate() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      <h1 className="mb-6 text-xl font-semibold text-gray-900 dark:text-gray-100">Create Instructor</h1>
      <form onSubmit={handleSubmit} className="rounded-lg border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
        ...
        <div className="mt-4">
          <p className="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Assigned Courses</p>
          <div className="max-h-48 overflow-y-auto rounded-md border border-gray-200 dark:border-gray-600 p-2">
            {allCourses.length === 0 ? (
